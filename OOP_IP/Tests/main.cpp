...
bool test_1_default_constructor() {
    ...
    TVector<int> vec;
    if (vec.size() != 0 || vec.capacity() != 15) {
        actual_result = false;
    }
    TestSystem::check(excepted_result, actual_result);
}


int main() {

    TestSystem::start_test(test_1_default_constructor, "test 1 default constcructor");
